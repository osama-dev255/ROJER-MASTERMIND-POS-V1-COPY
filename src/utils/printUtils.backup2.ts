    ...
    <div class="qr-section">
      ...
      ${qrCodeDataUrl ? 
        `<div style="text-align: center; margin: 10px 0;">
           <img src="${qrCodeDataUrl}" class="qr-code-img" alt="Receipt QR Code" style="max-width: 120px; height: auto; display: block; margin: 0 auto;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block'" />
           <div class="qr-code-fallback" style="display: none; font-family: monospace; font-size: 6px; line-height: 1.2; letter-spacing: 0px; padding: 5px; border: 1px solid #000; display: inline-block; margin: 5px auto; max-width: 100px; word-break: break-all;">QR Code Fallback</div>
           <div style="font-size: 8px; margin-top: 5px;">QR Code Generated</div>
         </div>` : 
        '<div style="font-size: 8px; color: red; margin: 10px 0; text-align: center;">QR Code not available</div>'}
    </div>
  </body>
</html>`;
    }
