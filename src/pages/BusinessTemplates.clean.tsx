          ...
          <div className="p-8 max-w-4xl mx-auto bg-white">
            ...
            <div className="grid grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded p-4 text-center">
                <p className="text-2xl font-bold text-yellow-800">142</p>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-bold text-gray-800 mb-4 border-b border-gray-300 pb-2">EXECUTIVE SUMMARY</h2>
              <div className="border border-gray-300 rounded p-4">
                <p className="mb-3">This report summarizes the business performance for the reporting period. Overall, we achieved strong growth across key metrics with total revenue increasing by 12% compared to the previous period.</p>
                <p className="mb-3">Our customer acquisition efforts were particularly successful, with 142 new customers representing a 25% increase in customer base growth. Customer satisfaction scores remained consistently high at 89%.</p>
                <p>Operational improvements contributed to improved profit margins, with net profit increasing by 15% despite increased investment in marketing and infrastructure.</p>
              </div>
            </div>
            
            <div className="grid grid-cols-2 gap-8 mb-8">
              <div>
                <h2 className="text-xl font-bold text-gray-800 mb-4 border-b border-gray-300 pb-2">FINANCIAL PERFORMANCE</h2>
